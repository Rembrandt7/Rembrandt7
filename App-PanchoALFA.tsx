      ...
      <div className="flex h-screen bg-transparent text-gray-100 font-sans overflow-hidden">
        ...
        {!isAssistantOpen && (
          <motion.button
            ...
            className="fixed bottom-6 left-6 p-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-full shadow-2xl z-50 pointer-events-auto"
          ...
          {isAssistantOpen && (
            <motion.div 
              ...
              transition={{ type: 'spring', damping: 25, stiffness: 300 }}
               className="fixed bottom-4 left-4 w-[450px] h-[650px] glass-panel-heavy rounded-3xl shadow-2xl flex flex-col z-50 overflow-hidden ring-1 ring-white/10"
            >
